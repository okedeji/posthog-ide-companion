...
import type { DetectionLogLevel } from '../workspace-detection';
import { createWorkspaceContextSection } from '../prompts';
...
describe('DETECTION_TOOLS', () => {
  it('should include read-only tools', () => {
    const names = DETECTION_TOOLS.map((t) => t.name);
